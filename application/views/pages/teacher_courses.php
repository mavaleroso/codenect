      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar sidebar-teach">,
            ...
            <li class="active"><a href="../index.php/teacher_courses" class="sidebar-text">Courses</a></li>
          </ul>
        </div>
      </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="game_form animated fadeInDown">
            <div class="row">
              <div class="c_nov ">
                ...
                <div class="row">
                  <div class="col-md-4 img_cnov">
                    <img src="../assets/img/novice_c.png" class="novice_c">
                  </div>
              ...
              <div class="c_nov">
                <div class="row">
                  <div class="col-md-4 img_cnov">
                    <img src="../assets/img/intermediate_c.png" class="novice_c">
                  </div>
                  <div class="col-md-4 des_cnov">
                  <ul>
            ...
            <div class="c_nov">
              <div class="row">
              <div class="col-md-4 img_cnov">
                <img src="../assets/img/advance_c.png" class="novice_c">
              </div>
              <div class="col-md-4 des_cnov">
                <ul>
                  <li>Structures</li>
          ...
          <div class="c_nov">
            ...
            <div class="row">
              <div class="col-md-4 img_cnov">
                <img src="../assets/img/novice_java.png" class="novice_c">
              </div>
            ...
            <div class="c_nov">
              <div class="row">
                <div class="col-md-4 img_cnov">
                  <img src="../assets/img/intermediate_java.png" class="novice_c">
                </div>
                <div class="col-md-4 des_cnov"></div>
                <div class="col-md-4 game_typev"></div>
              </div>
          ...
          <div class="c_nov">
            <div class="row">
              <div class="col-md-4 img_cnov">
            <img src="../assets/img/advance_java.png" class="novice_c">
          </div>
          <div class="col-md-4 des_cnov"></div>
            <div class="col-md-4 game_typev"></div>
          </div>
